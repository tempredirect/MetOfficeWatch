...
utils.nonUniqueIndexBy = (data, prop) ->
    propFn = if _.isFunction(prop) then prop else (o) -> o[prop]
...
leftPad = utils.leftPad = (value, size, pad) ->
...
dates = window.dates = {
    ...
    formatDateTime:(value) ->
        ...
        return "" + (value.getUTCDate() + 1) + " " + months[value.getUTCMonth()] + " " + leftPad(value.getUTCHours(),2,'0') + ":" + leftPad(value.getUTCMinutes(),2,'0');
    ,
    parse:(input) ->
